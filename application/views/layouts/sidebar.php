            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-folder"></i> Info Kecamatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url('kecamatan')?>">Kecamatan</a></li>
                    </ul>
                  </li>
                   <li><a><i class="fa fa-tags"></i> Info Jalan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                   ...
                   <li><a><i class="fa fa-map"></i> LeafletJs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url('leafletstandar')?>">MAP BANJARMASIN</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
